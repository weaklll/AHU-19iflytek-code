...
static const char* labels[]=
{
  "bulletproof_vest","first_aid_kit","spontoon","teargas","terrorist_one","terrorists_two","terrorists_three"
};
// static const char* labels[]={"rice", "wheat", "corn", "cuke", "corn1", "corn1_ugly",
//             "corn2", "corn2_green", "cuke1", "cuke2_long","cuke2_short", "cuke3", 
//             "watermelon_small","watermelon_big", "watermelon_circle", "watermelon_ugly", "apple", 
//             "apricot", "banana", "blueberry", "carambola", "coconut", "durian", "grape", "grapefruit", 
//             "hamimelon", "hawthorn", "hotpepper", "lemon","mango", "onion", "orange", "peach", "pear", 
//             "pepper","persimmon", "pineapple", "pitaya", "pomegranate", "potato", "pumpkin", "radish", 
//             "scallion", "sorghum","strawberry", "sunflower", "tangerine", "tomato", "whitegourd"} ;
